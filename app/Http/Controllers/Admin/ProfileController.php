...
class ProfileController extends Controller
{
    ...
    public function otp()
    {
        //
        $rrrr = "9315647380";
        event(new OtpEvent('9315647380'));

         event(new SendSmsEvent('9315647380','Dear ghfh. Your Registration Has Been Successfully Completed at '.preg_replace('#^https?://#', '', url('jjkb')).' Now You Can Login With User id jjjj and password llblj'));
return '//control.msg91.com/api/sendotp.php?authkey=193803AbcO0I6R55a607033&mobile=9315647380&message=123456hhhhh&sender=GRAHAK&otp=123456'
        return "ok";
    }
}
